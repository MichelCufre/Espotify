 ...
 * @author dokgo
 */
@WebFilter(filterName = "GuiFilter", urlPatterns = {"/*"})
public class GuiFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("GuiFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("GuiFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        // Verificar si el parámetro 'startGui' está presente en la solicitud
        String startGui = httpRequest.getParameter("startGui");

        if ("true".equals(startGui)) {
            // Solo inicializar la GUI si el parámetro startGui es 'true'
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("GuiFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("GuiFilter(");
