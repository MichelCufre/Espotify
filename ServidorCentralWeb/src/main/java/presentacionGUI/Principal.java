...
public class Principal extends javax.swing.JFrame {
    ...
    private ControladorPersistencia cpu;
    private iSistema sys;
    private boolean datosCargados = false;
    public Principal() {
        // Verificar si se puede crear la interfaz gráfica
        if (!GraphicsEnvironment.isHeadless()) {
            cpu = new ControladorPersistencia();
            ...
            System.err.println("No se puede crear GUI en entorno sin cabecera");
            // Opcional: lanzar una excepción o manejar el caso sin GUI
        }
    }

    // Método adicional para verificar si la GUI está disponible
    ...
    private void initComponents() {
        ...
        itemActualizarEstadoSubscripcion = new javax.swing.JMenuItem();
        ...
        jMenuItem_ConsultaBajaArtistas = new javax.swing.JMenuItem();
        jMenuItem_registrosAcceso = new javax.swing.JMenuItem();
        ...
        itemActualizarEstadoSubscripcion.setText("Actualizar Subscripciones");
        itemActualizarEstadoSubscripcion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itemActualizarEstadoSubscripcionActionPerformed(evt);
            }
        });
        menuSistema.add(itemActualizarEstadoSubscripcion);
        ...
        jMenuItem_ConsultaBajaArtistas.setText("Consulta Baja de Artistas");
        jMenuItem_ConsultaBajaArtistas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem_ConsultaBajaArtistasActionPerformed(evt);
            }
        });
        menuConsultas.add(jMenuItem_ConsultaBajaArtistas);

        jMenuItem_registrosAcceso.setText("Consulta Registros de Acceso al Sitio Web");
        jMenuItem_registrosAcceso.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem_registrosAccesoActionPerformed(evt);
            }
        });
        menuConsultas.add(jMenuItem_registrosAcceso);
    ...
    private void itemActualizarEstadoSubscripcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemActualizarEstadoSubscripcionActionPerformed
        // TODO add your handling code here:
       ActualizarEstadoSubscripcion acSub = new ActualizarEstadoSubscripcion();
       jPanel1.add(acSub);
       acSub.setVisible(true);
        try{
        acSub.setSize(822,620);
        }catch(Exception e){}
    }//GEN-LAST:event_itemActualizarEstadoSubscripcionActionPerformed

    private void jMenuItem_ConsultaBajaArtistasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_ConsultaBajaArtistasActionPerformed
        ConsultaBajaArtista consultaBaja = new ConsultaBajaArtista();
        jPanel1.add(consultaBaja);
        consultaBaja.setVisible(true);
        try{
            consultaBaja.setSize(890,650);
        }catch(Exception e){}
    }//GEN-LAST:event_jMenuItem_ConsultaBajaArtistasActionPerformed

    private void jMenuItem_registrosAccesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_registrosAccesoActionPerformed
        Registros registro = new Registros();
        jPanel1.add(registro);
        registro.setVisible(true);
        try{
            registro.setSize(890,675);
        }catch(Exception e){
            
        }
    }//GEN-LAST:event_jMenuItem_registrosAccesoActionPerformed

   

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JMenuItem itemActualizarEstadoSubscripcion;
    ...
    private javax.swing.JMenuItem jMenuItem_ConsultaBajaArtistas;
    private javax.swing.JMenuItem jMenuItem_registrosAcceso;
