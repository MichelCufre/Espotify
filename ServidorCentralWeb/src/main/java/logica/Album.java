   ...
   public Tema getTema(String nombreTema){
    ...
    if (this.Generos != null) {
        ...
        while (it.hasNext()) {
            ...
            genero.getAlbumes2().remove(this); // Asegura que también se elimine la referencia en el lado de Genero
            it.remove(); // Elimina el género del álbum
        }
    }
}
