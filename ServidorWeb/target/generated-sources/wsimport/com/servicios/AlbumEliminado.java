...
/**
 * <p>Clase Java para albumEliminado complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="albumEliminado"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="artista" type="{http://servicios.com/}artistaEliminado" minOccurs="0"/&gt;
 ...
 *         &lt;element name="temas" type="{http://servicios.com/}temaEliminado" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "albumEliminado", propOrder = {
    "artista",
    "fechaCreacion",
    "imagenAlbum",
    "nombre",
...
public class AlbumEliminado {

    protected ArtistaEliminado artista;
    protected Integer fechaCreacion;
    protected String imagenAlbum;
    protected String nombre;
    @XmlElement(nillable = true)
    protected List<TemaEliminado> temas;
     ...
     *     
     */
    public void setArtista(ArtistaEliminado value) {
        this.artista = value;
    }
    ...
    public List<TemaEliminado> getTemas() {
        if (temas == null) {
            temas = new ArrayList<TemaEliminado>();
        }
        return this.temas;
    }
