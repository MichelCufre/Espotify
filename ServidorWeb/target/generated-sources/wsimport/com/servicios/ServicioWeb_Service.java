 ...
 * 
 */
@WebServiceClient(name = "ServicioWeb", targetNamespace = "http://servicios.com/", wsdlLocation = "http://localhost:8080/ServidorCentralWeb/ServicioWeb?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOWEB_QNAME = new QName("http://servicios.com/", "ServicioWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServidorCentralWeb/ServicioWeb?wsdl");
    ...
    public ServicioWeb getServicioWebPort() {
        return super.getPort(new QName("http://servicios.com/", "ServicioWebPort"), ServicioWeb.class);
    }
    ...
    public ServicioWeb getServicioWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicios.com/", "ServicioWebPort"), ServicioWeb.class, features);
    }
