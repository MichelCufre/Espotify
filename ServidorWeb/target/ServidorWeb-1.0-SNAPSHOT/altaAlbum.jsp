    ...
    <div class="login-container bg-white p-4 rounded shadow">
        ...
        <form class="login-form" id="mainForm" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombreG" id="nombreG" class="form-control" readonly>
            ...
            <div id="archivoRadio" style="display: none;">
                <div class="form-group">
                    <label for="archivo">Archivo:</label>
                    <input type="file" name="archivo" id="archivo" class="form-control" accept=".mp3, .mpeg">
                </div>
            </div>
     ...
     <div class="container" id="containerListas">
            ...
            //convierte liststring en hassetstring
            List<String> generosList = sys.getGeneros();
            HashSet<String> generosCargados = new HashSet<>(generosList);
       ...
       $(document).ready(function() {
            ...
            function checkField(field, errorElement, checkType) {
                ...
                if (value.length > 0) {
                    ...
                    // Crear FormData y agregar el valor y tipo de verificación
