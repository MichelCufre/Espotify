                ...
                <div class="card plan-card">
                    <div class="card-body d-flex flex-column">
                        ...
                        <ul class="list-unstyled mt-auto">
                            ...
                            <li class="mb-2"><i class="fas fa-check feature-icon"></i> Ahora puedes añadir a favoritos tanto temas, listas y albumes</li>
                            <li class="mb-2"><i class="fas fa-check feature-icon"></i> Habilita la opcion de seguir a otro usuario</li>
                            <li class="mb-2"><i class="fas fa-check feature-icon"></i> Descarga cualquier canción</li>
                        </ul>
                    </div>
                </div>
            </div>
