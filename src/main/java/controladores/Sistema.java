...
public class Sistema implements iSistema{
    ...
    //Registrar usuario
        public void altaPerfil(String nickname, String nombre, String apellido, String email, LocalDate fechaNac, String imagen, String biografia, String sitioWeb, String tipo) throws UsuarioRepetidoException{
            ...
            if(u != null){
                ...
                Cliente nuevoUsuario = new Cliente(nickname, nombre, apellido, email, fechaNac, imagen,tipo);
                //addUsuario(nuevoUsuario);
                cpu.crearCliente(nuevoUsuario);
                }else if(ARTISTA.equals(tipo)){
                    Artista nuevoArtista = new Artista(nickname, nombre, apellido, email, fechaNac, imagen, biografia, sitioWeb, tipo);
...
//    }
   ...
   public void cargarDatos() throws GeneroRepetidoException, UsuarioRepetidoException{
    ...
    // Artistas
    altaPerfil("vpeople", "Village", "People", "vpeople@tuta.io", LocalDate.parse("1977-01-01"), "vpeople_artista.jpg", 
    ...
    altaPerfil("dmode", "Depeche", "Mode", "dmode@tuta.io", LocalDate.parse("1980-06-14"), "dmode_artista.jpg", 
        null, "www.depechemode.com", ARTISTA);

    altaPerfil("clauper", "Cyndi", "Lauper", "clauper@hotmail.com", LocalDate.parse("1953-06-22"), "clauper_artista.jpg", 
    ...
    altaPerfil("bruceTheBoss", "Bruce", "Springsteen", "bruceTheBoss@gmail.com", LocalDate.parse("1949-09-23"), "brucetheboss_artista.jpg", 
        null, "brucespringsteen.net", ARTISTA);

    altaPerfil("tigerOfWales", "Tom", "Jones", "tigerOfWales@tuta.io", LocalDate.parse("1940-06-07"), null, 
    ...
    altaPerfil("tripleNelson", "La Triple", "Nelson", "tripleNelson@tuta.io", LocalDate.parse("1998-01-01"), "triplenelson_artista.jpg", 
    ...
    altaPerfil("la_ley", "La", "Ley", "la_ley@tuta.io", LocalDate.parse("1987-02-14"), null, null, null, ARTISTA);

    altaPerfil("chaiko", "Piotr", "Tchaikovsky", "chaiko@tuta.io", LocalDate.parse("1840-04-25"), null, 
        "Piotr Ilich Chaikovski fue un compositor ruso del período del Romanticismo.", 
        null, ARTISTA);

    altaPerfil("nicoleneu", "Nicole", "Neumann", "nicoleneu@hotmail.com", LocalDate.parse("1980-10-31"), "nicoleneuman_artista.jpg", null, null, ARTISTA);

    altaPerfil("lospimpi", "Pimpinela", null, "lospimpi@gmail.com", LocalDate.parse("1981-08-13"), "pimpinela_artista.jpg", null, "www.pimpinela.net", ARTISTA);

    altaPerfil("dyangounchained", "Dyango", null, "dyangounchained@gmail.com", LocalDate.parse("1940-03-05"), null, 
        "José Gómez Romero, conocido como Dyango, es un cantante español de música romántica.", 
        null, ARTISTA);

    altaPerfil("alcides", "Alcides", null, "alcides@tuta.io", LocalDate.parse("1952-07-17"), null, 
    ...
    // Clientes
    altaPerfil("el_padrino", "Vito", "Corleone", "el_padrino@tuta.io", LocalDate.parse("1972-03-08"), "vitoCorleone_cliente.JPG", null, null, CLIENTE);

    altaPerfil("scarlettO", "Scarlett", "O'Hara", "scarlettO@tuta.io", LocalDate.parse("1984-11-27"), "scarletto_cliente.jpg", null, null, CLIENTE);

    altaPerfil("ppArgento", "Pepe", "Argento", "ppArgento@hotmail.com", LocalDate.parse("1955-02-14"), "pepeargento_cliente.png", null, null, CLIENTE);

    altaPerfil("Heisenberg", "Walter", "White", "Heisenberg@tuta.io", LocalDate.parse("1956-03-07"), "heisenbergBD_cliente.png", null, null, CLIENTE);

    altaPerfil("benKenobi", "Obi-Wan", "Kenobi", "benKenobi@gmail.com", LocalDate.parse("1914-04-02"), "Ben_Kenobi.png", null, null, CLIENTE);

    altaPerfil("lachiqui", "Mirtha", "Legrand", "lachiqui@hotmail.com.ar", LocalDate.parse("1927-02-23"), "Mirtha_Legrand_cliente.jpg", null, null, CLIENTE);

    altaPerfil("cbochinche", "Cacho", "Bochinche", "cbochinche@vera.com.uy", LocalDate.parse("1937-05-08"), "cachobochinche_cliente.jpg", null, null, CLIENTE);

    altaPerfil("Eleven11", "Eleven", null, "Eleven11@gmail.com", LocalDate.parse("1971-12-31"), "eleven_cliente.png", null, null, CLIENTE);
