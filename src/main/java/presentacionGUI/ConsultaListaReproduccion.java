...
public class ConsultaListaReproduccion extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, 470, 180));
    ...
    private void cmbTipoPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_cmbTipoPopupMenuWillBecomeInvisible
        ...
        model2.setRowCount(0);
        model2.setColumnIdentifiers(new Object[]{"Posicion","Nombre", "Duracion", "Direccion Web", "Archivo"});
        ...
        while(it.hasNext()){
            ...
            model2.addRow(new Object[]{dtTema.getPosicion(),dtTema.getNombre(),dtTema.getDuracion(),dtTema.getDireccionWeb(),dtTema.getArchivo()});
        }
