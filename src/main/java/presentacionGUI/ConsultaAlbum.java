   ...
   iSistema sys = new Fabrica().getSistema();
    ...
    private void cb_albumgenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_albumgenActionPerformed
        ...
        if (albumSeleccionadoObj != null && generoSeleccionadoObj != null) {
            ...
            try {
                Album album = sys.getAlbumEspecificoGen(albumSeleccionado, generoSeleccionado);
                ...
                model.addRow(new Object[]{
                    ...
                    album.getGeneros().stream().map(Genero::getNombre).collect(Collectors.joining(", "))
                });
    ...
    if (albumSeleccionadoObj != null && artistaSeleccionadoObj != null) {
        ...
        try {
            Album album = sys.getAlbumEspecificoArt(albumSeleccionado, artistaSeleccionado);
